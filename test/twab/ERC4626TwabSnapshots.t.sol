...
import { ERC4626TwabSnapshots } from '../../src/twab/ERC4626TwabSnapshots.sol';

contract ERC4626Test is Test {
  ERC20TwabSnapshots underlying;
  ERC4626TwabSnapshots vault;

  function setUp() public {
    underlying = new ERC20TwabSnapshots();
    underlying.initialize('Mock Token', 'TKN');
    vault = new ERC4626TwabSnapshots();
    vault.initialize(underlying, 'Mock Token Vault', 'vwTKN');
  }
  ...
  function testMetadata(string calldata name, string calldata symbol) public {
    ERC4626TwabSnapshots vlt = new ERC4626TwabSnapshots();
    vlt.initialize(underlying, name, symbol);
  ...
  function testMultipleMintDepositRedeemWithdraw() public {
    ...
    console.log(underlying.balanceOf(alice));
    console.log(underlying.balanceOf(bob));
